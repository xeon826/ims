...
bitnami-lampstack-7.1.20-0-linux-installer.run on Linux or
bitnami-lampstack-7.1.20-0-linux-x64-installer.run on Linux 64 bit.
...
chmod 755 bitnami-lampstack-7.1.20-0-linux.run
...
a regular user, or /opt/lampstack-7.1.20-0, if you are running the 
...
/home/user/lampstack-7.1.20-0 and that you use port 8080 for Apache and 3306 for MySQL.
...
"Cannot open bitnami-lampstack-7.1.20-0-linux.run: No application suitable for 
